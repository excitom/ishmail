/*
 * $Id: regex.c,v 1.3 2000/05/07 12:26:11 fnevgeny Exp $
 *
...
static int hre_compile_initialized = 0;
...
static void hre_compile_initialize()
{
  int a;
...
char *hre_compile_pattern(regex, size, bufp)
char *regex;
int size;
regexp_t bufp;
{
