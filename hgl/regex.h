/*
 * $Id: regex.h,v 1.1.1.1 2000/04/25 13:49:02 fnevgeny Exp $
 *
...
int hre_set_syntax(int syntax);
/* This sets the syntax to use and returns the previous syntax.  The
   syntax is specified by a bit mask of the above defined bits. */

/*
char *hre_compile_pattern(char *regex, int regex_size, regexp_t compiled);
*/
...
/*
int hre_match(regexp_t compiled, char *string, int size, int pos,
...
int hre_match_2(regexp_t compiled, char *string1, int size1,
...
/*
int hre_search(regexp_t compiled, char *string, int size, int startpos,
...
int hre_search_2(regexp_t compiled, char *string1, int size1,
		char *string2, int size2, int startpos, int range,
		regexp_registers_t regs, int mstop);
/* This is like hre_search, but search from the concatenation of string1 and
   string2.  */

void hre_compile_fastmap(regexp_t compiled);
/* This computes the fastmap for the regexp.  For this to have any effect,
   the calling program must have initialized the fastmap field to point
   to an array of 256 characters. */

/*char *hre_comp(char *s); */
/* BSD 4.2 regex library routine hre_comp.  This compiles the regexp into
   an internal buffer.  This returns NULL if the regexp was compiled
   successfully, and an error message if there was an error. */

/*int hre_exec(char *s); */
/* BSD 4.2 regexp library routine hre_exec.  This returns true if the string
