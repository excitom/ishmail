...
%token	tDAY tDAYZONE tMERIDIAN tMONTH tMONTH_UNIT tSEC_UNIT
%token	tUNUMBER tUNKNOWN tZONE

%type	<Number>	tDAYZONE tMONTH tMONTH_UNIT tSEC_UNIT
%type	<Number>	tUNUMBER tZONE s_number numzone zone qzone
...
rel	: s_number tSEC_UNIT {
	    yyRelSeconds += $1 * $2;
	}
	| tUNUMBER tSEC_UNIT {
	    yyRelSeconds += $1 * $2;
	}
	| s_number tMONTH_UNIT {
	    yyRelMonth += $1 * $2;
	}
