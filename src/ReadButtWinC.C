/*
 *  $Id: ReadButtWinC.C,v 1.2 2000/05/07 12:26:12 fnevgeny Exp $
 *  
...
ReadButtWinC::ReadButtWinC(Widget par, ButtonMgrC *mgr) : ButtPrefWinC(par, mgr)
{
}
...
ReadButtWinC::Write()
{
   ReadButtPrefC	*prefs    = ishApp->readButtPrefs;
