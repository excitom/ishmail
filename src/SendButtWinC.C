/*
 *  $Id: SendButtWinC.C,v 1.2 2000/05/07 12:26:12 fnevgeny Exp $
 *  
...
SendButtWinC::SendButtWinC(Widget par, ButtonMgrC *mgr) : ButtPrefWinC(par, mgr)
{
}
...
SendButtWinC::Write()
{
   SendButtPrefC	*prefs    = ishApp->sendButtPrefs;
